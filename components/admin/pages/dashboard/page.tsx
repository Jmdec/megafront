...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    dispatch(fetchClosedDealStatistics());
    dispatch(fetchRealEstateNewsStatistics());
    dispatch(fetchRealEstateTipsStatistics());
    dispatch(fetchOngoingInfrastructureStatistics());
  }, [dispatch]);
        ...
        <>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-4xl font-semibold text-[#B8986E]">
                {totalProperties}
              </p>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                {Object.entries(propertyStatusCounts || {}).map(
                  ([status, count]) => (
                    <div
                      key={status}
                    ...
                    >
                      ...
                      <p className="text-xl font-bold text-[#B8986E]">
                        {count}
                      </p>
                    </div>
                  )
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                {Object.entries(officeStatusCounts || {}).map(
                  ([status, count]) => (
                    <div
                      key={status}
                      className="p-3 bg-gray-100 rounded-lg shadow-sm"
          ...
          <div className="mt-8 bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              ...
              {[
                ...
                {
                  label: "🏗️ Ongoing Infrastructure",
                  value: totalOngoingInfrastructures,
                },
              ].map((item) => (
                <div
                  key={item.label}
