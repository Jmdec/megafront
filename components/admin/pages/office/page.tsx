...
import { fetchOffices, deleteOffice } from "@/app/redux/services/officeService";
...
export default function OfficePage() {
  ...
  const { offices, loading } = useSelector(
    (state: RootState) => state.officeData
  );
  ...
  const columns = [
    {
      name: "Name",
      selector: (row: Office) => row.name || "N/A",
      sortable: true,
    },
    {
      name: "Location",
      selector: (row: Office) => row.location || "N/A",
      sortable: true,
    },
    {
      name: "Status",
      selector: (row: Office) => row.status || "N/A",
      sortable: true,
    }, // 🔹 Changed from "Division" to "Status"
    {
      name: "Price",
      selector: (row: Office) => row.price || "N/A",
      sortable: true,
      wrap: true,
    },
    {
      name: "Lot Area",
      selector: (row: Office) => row.lotArea || "N/A",
      sortable: true,
    },
    {
      name: "Image",
  ...
  const filteredOffices = offices.filter((property: Office) =>
      ...
      {deleteModalOpen && officeToDelete && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50 z-50">
          <div className="bg-white p-6 rounded-md shadow-md w-80">
            ...
            <p className="mb-4">
              Are you sure you want to delete the office "{officeToDelete.name}
              "?
            </p>
