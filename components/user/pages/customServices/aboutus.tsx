...
const AboutUs = () => {
  return (
    <div className="bg-gray-50 py-10 px-4 sm:px-6">
      <div className="w-full max-w-6xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
        {/* Hero Section */}
        ...
        {/* About Section */}
        <div className="p-6 sm:p-10 md:p-8 text-center">
          ...
          <p className="text-gray-700 leading-relaxed max-w-3xl mx-auto text-sm sm:text-md">
        ...
        {/* Our Story Section */}
        <div className="py-6 px-6 sm:px-10 md:px-16 bg-gradient-to-r from-gray-100 to-gray-200">
          ...
          <p className="text-gray-700 leading-relaxed text-center max-w-3xl mx-auto text-sm sm:text-md">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-10 p-6 sm:p-10 md:p-16">
          {/* Vision */}
          <div className="p-6 bg-white shadow-lg rounded-lg flex flex-col items-center text-center border-l-4 border-blue-600">
            <FaGlobe className="text-blue-600 text-3xl sm:text-4xl mb-2 sm:mb-3" />
          ...
          {/* Mission */}
          <div className="p-6 bg-white shadow-lg rounded-lg flex flex-col items-center text-center border-l-4 border-blue-600">
            <FaBullseye className="text-blue-600 text-3xl sm:text-4xl mb-2 sm:mb-3" />
            <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2">
              Our Mission
            </h2>
            <p className="text-gray-700 text-sm sm:text-md">
        ...
        {/* Core Values Section */}
        <div className="py-10 sm:py-16 px-6 sm:px-10 md:px-16 bg-gray-50">
            ...
            {[
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm sm:text-md mt-1 sm:mt-2">
                    {value.desc}
                  </p>
                </div>
              </div>
        ...
        <div className="p-6 sm:p-10 md:p-16 text-center">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-4 flex justify-center items-center">
            <FaUsers className="text-blue-600 mr-2" /> Get in Touch
          </h2>
          <p className="text-gray-700 text-sm sm:text-md mb-4 sm:mb-6">
            Our experienced professionals are ready to assist you with your real
            estate needs.
          </p>

          <div className="bg-gray-50 p-4 sm:p-6 rounded-lg shadow-md inline-block text-left">
            <p className="text-gray-700 flex items-center text-sm sm:text-md">
