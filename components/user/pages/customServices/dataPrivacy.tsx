...
const DataPrivacy = () => {
 return (
  ...
  <h1 className="text-4xl font-bold tracking-wide">DATA PRIVACY POLICY</h1>
    ...
    Last Updated: <span className="font-semibold">February 13, 2025</span>
      ...
      <div className="p-10 space-y-8">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">3. Data Protection Measures</h2>
            <ul className="list-disc list-inside text-gray-700 space-y-2">
          ...
          <div className="p-6 rounded-lg shadow-sm border-l-4 border-blue-500">
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">4. Third-Party Services</h2>
          ...
          <div className="p-6 rounded-lg shadow-sm border-l-4 border-blue-500">
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">6. Updates to this Policy</h2>
            <p className="text-gray-700">
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
            ...
            <p className="text-gray-700">
              If you have any questions or concerns regarding this Data Privacy Policy, please contact us:
            </p>
