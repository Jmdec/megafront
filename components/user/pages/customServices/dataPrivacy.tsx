...
const DataPrivacy = () => {
  return (
    <div className="min-h-screen   w-[60%] mx-auto border-x-2">
      <div className=" mx-auto bg-white shadow-lg rounded-lg p-12">
        ...
        <div className="space-y-6">
          ...
          <div>
            <h2 className="text-xl font-semibold text-gray-900 mb-2">3. Data Protection Measures</h2>
            <ul className="list-disc list-inside text-gray-700 space-y-2">
          ...
          <div>
            ...
            <p className="text-gray-700">If you have any questions or concerns regarding this Data Privacy Policy, please contact us:</p>
